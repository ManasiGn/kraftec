 ...
 $target_dir="../Controller/uploads/";
  $image = $target_dir.basename($_FILES["pimage"]["name"]);
   move_uploaded_file($_FILES["pimage"]["tmp_name"],$image);
      ...
      $stmt=$admin->cud("INSERT INTO `prescription`(`uid`,`rid`,`image`)VALUES ('".$a."','".$b."','".$image."')","saved");
    ...
    //Recipients
    $mail->setFrom('kraftec@gmail.com', 'KALPATARU MEDICALS ARSIKERE');
    $mail->addAddress($email,$name);

    // Content
    $mail->isHTML(true);
    $mail->Subject = 'this is subject';
    $mail->Body    = 'The item is ready.. It will be delivered soon .';
