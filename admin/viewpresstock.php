...
<head>
  ...
  <title>Prescription Stock</title>
  <!-- plugins:css -->
                    ...
                    <table class="table table-hover">
                      <thead>
                        ...
                        <th>DRUG</th>
                          ...
                          <th>ADD PRESCRIBED STOCK</th>
                        </tr>
                      </thead>

                      <?php
    $i=1;
     $stmt = $admin->ret("SELECT * FROM `product` WHERE `catg`='PRESCRIPTION'");
    ...
    ?>
                     ...
                     <td><img src="../Controller/<?php echo $row['pimage'];?>" style="height:100px;width:100px;"></td> 
                       ...
                       <td><?php echo $row['stock'];?></td>
                        ...
                        <td>  <a href="addpresstock.php?id=<?php echo $row['pid']; ?>" class="btn btn-primary"
                       onclick="return confirm('add prescrribed stock?')"><b><i>UPDATE STOCK</i></b></a></td>
