    ...
    ?>
                     ...
                     <td><?php echo $row['uname'];?></td>
                        ...
                        <td><?php echo $row['ostatus'];?></td>
                            <td>  <a href="../phpmailer/sendMail.php?id=<?php echo $row['orid']; ?>&name=<?php echo $row['uname'];?> &email=<?php echo $row['uemail'];?>" class="btn btn-success"
                       onclick="return confirm('Accept the request?')"><b><i>Accept</i></b></a></td>


                    <td>  <a href="../phpmailer/sendMail1.php?id=<?php echo $row['orid']; ?>&name=<?php echo $row['uname'];?> &email=<?php echo $row['uemail'];?>" class="btn btn-danger"
